...
const SuperInput = forwardRef((props, ref) => {
        ...
        const [list, setList] = useState(props.list.filter(e=>e) || [])
        ...
        const [value, setValue] = useState(props.list ? props.list[0] : "")
        ...
        const handleOptionClick=(e)=>{
          ...
          handleChange({value,selectedIndex})
        }
        ...
        const handleChange=({value,selectedIndex})=>{
          ...
          >
            ...
            {label ?
                <div className="form-floating w-100">
                  ...
                  <label className="form-label text-body-tertiary small">{label}</label>
                </div>
              :
